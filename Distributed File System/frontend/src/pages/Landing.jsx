    ...
    <div className="min-h-full flex flex-col">
      ...
      <header className="sticky top-0 z-40 glass bg-white/40 dark:bg-neutral-950/45 border-b border-blue-100/60 dark:border-white/[0.06]">
        <div className="max-w-5xl mx-auto px-6 flex items-center justify-between" style={{ height: 56 }}>
          ...
          <div className="flex items-center gap-2">
            <a
              href="#download"
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold bg-blue-600 hover:bg-blue-500 dark:bg-[#0067C0] dark:hover:bg-[#005ba1] text-white transition-all duration-150 hover:-translate-y-0.5 active:translate-y-0"
            >
              <Download size={12} />
              Download
            </a>
      ...
      <main className="flex-1">
        ...
        <section className="max-w-5xl mx-auto px-6 pt-24 pb-20 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold bg-blue-50 dark:bg-[#0067C0]/10 text-blue-600 dark:text-[#4cc2ff] border border-blue-200/70 dark:border-[#0067C0]/25 mb-6">
            <ShieldCheck size={12} />
          ...
          <h1 className="text-5xl sm:text-6xl font-extrabold text-gray-900 dark:text-white tracking-tight leading-tight mb-5">
            Distributed.<br />
            <span className="text-blue-600 dark:text-[#4cc2ff]">Encrypted.</span> Yours.
          </h1>
          ...
          <div className="flex items-center justify-center">
            ...
            <a
              href="#download"
              className="flex items-center gap-2 px-5 py-3 rounded-xl text-sm font-semibold bg-blue-600 hover:bg-blue-500 dark:bg-[#0067C0] dark:hover:bg-[#005ba1] text-white transition-all duration-150 hover:-translate-y-0.5 active:translate-y-0"
            >
              <Download size={15} />
              Download the app
            </a>
        ...
        <section className="max-w-5xl mx-auto px-6 py-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {FEATURES.map(({ icon: Icon, title, desc }) => (
              ...
              >
                <div className="w-9 h-9 rounded-xl bg-blue-50 dark:bg-[#0067C0]/10 flex items-center justify-center mb-4">
                  <Icon size={16} className="text-blue-600 dark:text-[#4cc2ff]" />
                </div>
        ...
        <section id="download" className="max-w-5xl mx-auto px-6 py-20 text-center scroll-mt-16">
          <div className="glass bg-white/75 dark:bg-neutral-900/70 rounded-3xl border border-gray-100 dark:border-neutral-800 px-8 py-14">
            <div className="w-14 h-14 bg-blue-600 dark:bg-[#0067C0] rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-blue-500/20 dark:shadow-[#0067C0]/20">
      ...
      <footer className="border-t border-gray-100 dark:border-white/[0.06]">
        <div className="max-w-5xl mx-auto px-6 py-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-5 h-5 bg-blue-600 dark:bg-[#0067C0] rounded-md flex items-center justify-center">
